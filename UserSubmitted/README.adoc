...
.5+.^|Sensor (Micro USB) | |Official 'Full Sensor' with Micro USB port  | .5+.^| FDM/Resin .5+.^| https://materialfoundry.github.io/MaterialPlane/DIY/BuildInstructions/sensorFull/[Instructions] .5+.^| Material Foundry info@materialfoundry.nl .5+.^| image:Sensor_Official.jpg[,150]
...
.5+.^|Sensor (USB-C) | |Official 'Full Sensor' with USB-C port  | .5+.^| FDM/Resin .5+.^| https://materialfoundry.github.io/MaterialPlane/DIY/BuildInstructions/sensorFull/[Instructions] .5+.^| Material Foundry info@materialfoundry.nl .5+.^| image:Sensor_Official.jpg[,150]
...
| Micstand Mount | | Simple microphone mount for the DFRobot sensor | https://github.com/MaterialFoundry/MaterialPlane_Models/blob/main/Sensor/MicstandMount.stl[stl], https://github.com/MaterialFoundry/MaterialPlane_Models/blob/main/Sensor/MicstandMount.step[step] | FDM/Resin || Material Foundry info@materialfoundry.nl | image:MicstandMount_Official.jpg[,150]
