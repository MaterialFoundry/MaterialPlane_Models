...
| Base_Brick_Magnet | Base modified by Nivenante. Can accomodate Lego minifigures and a bottom cover. [25x25x7mm | https://github.com/MaterialFoundry/MaterialPlane_Models/blob/main/UserSubmitted/Nivenante/Base_Brick_Magnet.step | FDM/Resin | https://materialfoundry.github.io/MaterialPlane/DIY/BuildInstructions/base/[Instructions]

| Base_Brick_Cover | Bottom cover by Nivenante. Secured in place by magnets. | 25x25x4mm | https://github.com/MaterialFoundry/MaterialPlane_Models/blob/main/UserSubmitted/Nivenante/Base_Brick_Magnet.step | FDM/Resin | https://materialfoundry.github.io/MaterialPlane/DIY/BuildInstructions/base/[Instructions]
